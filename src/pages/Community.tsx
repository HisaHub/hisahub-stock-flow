...
import { Heart, MessageCircle, Share2, TrendingUp, TrendingDown, Plus, Send, X } from "lucide-react";
...
const Community: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-primary font-sans transition-colors pb-20">
      ...
      <main className="flex-1 w-full max-w-2xl mx-auto flex flex-col px-4 py-6">
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-off-white/60 text-sm mt-1">
              Share ideas, discuss markets, connect with traders
            </p>
          </div>
        </div>
      ...
      <Dialog open={isCreatePostOpen} onOpenChange={setIsCreatePostOpen}>
        <DialogTrigger asChild>
          <Button
            className="fixed bottom-20 right-4 w-14 h-14 rounded-full bg-secondary text-primary shadow-lg hover:shadow-xl transition-all z-40"
            size="icon"
          >
