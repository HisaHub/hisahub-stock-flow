  ...
  return (
    <>
      <Button
        ...
        title="Chat with Local AI Model"
      >
        <Bot size={20} />
      </Button>
          ...
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-2xl h-[80vh] flex flex-col overflow-hidden">
            ...
            <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-white p-4 flex items-center justify-between shrink-0">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h1 className="text-lg font-bold">Hisa AI</h1>
                  <p className="text-sm text-blue-100">LM Studio - 127.0.0.1:11434</p>
                </div>
              </div>
              <div className="flex items-center gap-2">
                <Button
                  ...
                  variant="ghost"
                  size="sm"
                  className="text-white hover:bg-white/20 rounded-lg px-3 py-1 text-xs"
                >
                  Clear
                </Button>
                <Button
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-4">
              {messages.length === 0 && (
                <div className="text-center text-gray-500 mt-8">
                  ...
                  <p className="text-xs mt-2 text-gray-400">Connected to local AI at 127.0.0.1:11434</p>
                </div>
              )}
            ...
            <div className="border-t p-4 shrink-0">
              <div className="flex gap-3">
                <Input
                  ...
                  placeholder="Ask your local AI model anything..."
                  className="flex-1"
                  disabled={loading}
                />
                <Button
